  ...
  return (
    <div className="tool-card" onClick={() => navigate(tool.path)}>
      ...
      <div className="tool-card-icon">
        ...
        {category && (() => {
          const CatIcon = (Icons as unknown as Record<string, React.ComponentType<{ size?: number }>>)[category.icon] || Icons.Folder
          return (
            <span className="tool-card-category-badge" style={{ background: category.color }}>
              <CatIcon size={10} />
            </span>
          )
        })()}
